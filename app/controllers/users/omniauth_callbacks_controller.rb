# This is the controller that is called back by the third party authorization service.
# This controller and class abstract the rest of the application from the details of 
# the authentication.
class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  before_filter { @omniauth_hash = env["omniauth.auth"] }

  # I have added this line otherwise the rails server (thin) resets the session everytime 
  # the user sign in with an open id provider.
  # The problem: session is reset by server and the following warning message is set in the logs:
  #
  ...
  #
  # So I have followed the following instructions:
  #  http://stackoverflow.com/questions/5049994/omniauth-current-session-not-loaded-on-openid-callback
  # 
  # but now I get the following in the log messages:
  #
  # Error attempting to use stored discovery information: OpenID::TypeURIMismatch
  #
  # I have no idea how to get rid of this message or what it means.
  # (see also http://toddsedano.blogspot.com/2010/05/integrating-openid-google-apps-and-ruby.html)
  #
  # IN OTHER WORDS THE ONLY THING THAT MAKES THE SESSION WORK IS TO ADD
  # THE FOLLOWING LINE:
  #
